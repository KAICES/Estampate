...
public class EstampaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<tr><td>Tema</td><td>Rating</td><td>Popularidad</td><td>Autor</td></tr>");
            for(Estampas e:misE){
                         
              out.println("<tr><td>"+e.getNombreEstampa()+"</td><td>"+e.getRating()+" unds</td><td>"+e.getPopularidad()+" pts</td><td>"+e.getAutor()+"</td></tr>");     
            }  
